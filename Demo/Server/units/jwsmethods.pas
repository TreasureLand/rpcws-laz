...
type
  ...
  published
    ...
    function Transaction(Request: TJWSRequestContent): TJSONStringType;
...
function TJWSMethods.Transaction(Request: TJWSRequestContent): TJSONStringType;
var ADBConnector : TS7SDBConnector;
    AProvider    : TS7SProvider;
    AJsonObject    : String;
    vJson          : TJSONObject;
...
function TJWSMethods.getIdTable(Request: TJWSRequestContent): TJSONStringType;
